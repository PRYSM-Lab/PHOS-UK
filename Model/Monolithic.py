...
model.AY = Var(model.d1, model.Npipe, model.TT, within=NonNegativeReals, bounds=(0,1), doc="availability of hydrogen pipelines of diameter size d for regional distribution in region g in time period t")
model.AYon=Var(model.d2, model.N, model.TT, within=NonNegativeReals, bounds=(0,1), doc="availability of onshore CO2 pipelines of diameter size d for local distribution in region g in time period t")
model.AYoff = Var(model.d2, model.GR, model.TT, within=NonNegativeReals, bounds=(0,1), doc="availability of offshore CO2 pipelines of diameter size d for local distribution in region g in time period t")
model.AYst = Var(model.d1, model.GS2, model.TT, within=NonNegativeReals, bounds=(0,1), doc="availability of hydrogen pipelines of diameter size d for distribution in region g in time period t")
...
model.IMP = Var(model.g, model.TT, model.CC, model.h, within=NonNegativeReals,doc='Flow rate of international import (MW)')
...
df.to_excel("resultsMon.xlsx", index=False, sheet_name="All Data")

print("All variables and objective saved in 'resultsMon.xlsx'")
#%%
...
# Title and clean up
ax.set_title("ATRCCS Installed Capacity per Region (MW)", fontsize=20, color='darkgreen')
ax.axis('off')
